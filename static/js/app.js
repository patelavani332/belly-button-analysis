// Creating bubble chart and bar chart for the samples 
...
function buildCharts(sample){
    ...
    // Create bubble chart for bacteria cultures per sample. (OTU ID vs sample values)
        let bubbleLayout = {
    ...
    // Create horizontal bar chart for top 10 bacteria cultures found in individual 
...
// Displaying individual's demographic information (sample metadata)
